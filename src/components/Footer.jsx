    ...
    <footer className="border-t border-slate-800 bg-slate-950 text-white">
      <div className="site-container py-12 lg:py-16">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-[1.4fr_.7fr_.7fr_1.2fr]">
          <div><Link to="/" aria-label="Electro home" className="inline-flex items-center gap-1.5"><img src={Logo} alt="" className="h-10 w-10 object-cover object-left" /><span className="title text-base font-extrabold tracking-[0.16em]">ELECTRO</span></Link><p className="mt-4 max-w-sm text-sm leading-6 text-slate-400">Premium technology chosen for performance, creativity, and everyday life.</p><div className="mt-5 space-y-2 text-sm text-slate-400"><p className="flex items-center gap-2"><MapPin className="h-4 w-4" /> Riyadh, Saudi Arabia</p><p className="flex items-center gap-2"><Phone className="h-4 w-4" /> +966 11 000 0000</p></div></div>
