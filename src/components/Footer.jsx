...
const supportLinks = [
  ...
  { to: "/home", label: "All products" },
];
const linkClass =
  "text-sm text-slate-400 transition hover:text-white focus-visible:text-white";
    ...
    <footer className="border-t border-slate-800 bg-slate-950 text-white">
      <div className="site-container py-12 lg:py-16">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-[1.4fr_.7fr_.7fr_1.2fr]">
          <div>
            ...
            <p className="mt-4 max-w-sm text-sm leading-6 text-slate-400">
              Premium technology chosen for performance, creativity, and
              everyday life.
            </p>
            <div className="mt-5 space-y-2 text-sm text-slate-400">
              <p className="flex items-center gap-2">
                <MapPin className="h-4 w-4" /> Medina, Saudi Arabia
              </p>
              <p className="flex items-center gap-2">
                <Phone className="h-4 w-4" /> +966 56 338 5571
              </p>
            </div>
          </div>
          <div>
            <h2 className="text-sm font-bold uppercase tracking-wider">Shop</h2>
          ...
          <div>
            ...
            <p className="mt-3 text-sm text-slate-400">
              New devices, practical tips, and member offers.
            </p>
            <form
            ...
            >
              ...
              <div className="relative min-w-0 flex-1">
                ...
                <input
                  ...
                  className="h-12 w-full rounded-xl border border-slate-700 bg-slate-900 pl-10 pr-3 text-sm text-white placeholder:text-slate-500 focus:border-blue-500"
                />
              </div>
              <button
                type="submit"
        ...
        <div className="mt-10 flex flex-col gap-3 border-t border-slate-800 pt-6 text-xs text-slate-500 sm:flex-row sm:items-center sm:justify-between">
          <p>© 2026 Electro. All rights reserved.</p>
          <p>Designed for smarter technology shopping.</p>
        </div>
      </div>
    </footer>
  );
